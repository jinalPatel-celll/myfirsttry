...
<body>
<H6>this is VIEW COUNTRY page</H6>
...
//    foreach ($viewcountry_res->result() as $row) 
    {
    ?>			
           <div >

            <option value="<?php  $rowcountry_id ;?>">	<?php //echo "$row->country_name";?></option>
            </div>	
...
<?php
    ...
    $viewcountry_res = $this->db->get('tbl_country');
